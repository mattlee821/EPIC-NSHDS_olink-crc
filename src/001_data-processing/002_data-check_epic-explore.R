...
# data ====
data_meta_controls <- data.table::fread("data/processed/EPIC_olink-explore_sample-metadata-controls.txt")
data_meta_features <- data.table::fread("data/processed/EPIC_olink-explore_feature-metadata.txt")
data_meta_samples <- data.table::fread("data/processed/EPIC_olink-explore_sample-metadata.txt")
data_features_controls <- data.table::fread("data/processed/EPIC_olink-explore_feature-data-controls.txt")
data_features_samples <- data.table::fread("data/processed/EPIC_olink-explore_feature-data.txt")
...
write.table(data_meta_samples, "analysis/001_data-processing/EPIC_olink-explore_sample-metadata.txt", 
...
grDevices::tiff(filename = "analysis/001_data-processing/EPIC_olink-explore_distribution-samples.tiff", 
...
grDevices::tiff(filename = "analysis/001_data-processing/EPIC_olink-explore_scatter-batch.tiff", 
...
# write ====
write.table(data_meta_features, "analysis/001_data-processing/EPIC_olink-explore_feature-metadata.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
