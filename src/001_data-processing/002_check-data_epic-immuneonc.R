...
# data ====
data <- data.table::fread("data/processed/EPIC_olink-immuneonc.txt") %>%
  tibble::as_tibble()
...
grDevices::pdf("analysis/001_data-processing/EPIC_olink-immuneonc_distribution-samples.pdf",
               width = 20, height = 20)
...
grDevices::pdf("analysis/001_data-processing/EPIC_olink-immuneonc_scatter-batch.pdf",
               width = 16, height = 8)
...
# write ====
write.table(table_all, "analysis/001_data-processing/EPIC_olink-immuneonc_metadata-across-batches.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(table_batch, "analysis/001_data-processing/EPIC_olink-immuneonc_metadata-within-batches.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
