...
## save ====
write.table(x = table, file = "analysis/tables/manuscript/results-colocalisation.txt",
            quote = FALSE, sep = "\t", row.names = F, col.names = T)

wb <- createWorkbook()
addWorksheet(wb = wb, sheetName = "coloc-results")
writeData(wb = wb, sheet = "coloc-results", table, colNames = T, rowNames = F)
